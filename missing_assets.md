...
|------|------|----------------------|--------------------------|
| lava_boss_1 | `res://assets/bosses/lava/lava_boss_1.png` and `.tres` | Lava boss warship or volcanic entity, hand-painted style, molten ember raider, circular silhouette with magma cracks, obsidian shell plates and flame vents, red-orange core with black rock armor, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred fifty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, ember flicker, flame pulse, idle burn, seamless loop. |
| lava_boss_2 | `res://assets/bosses/lava/lava_boss_2.png` and `.tres` | Lava boss warship or volcanic entity, hand-painted 2D game sprite, obsidian horn fighter, triangular silhouette with molten channels, sharp rock fins and blazing vents, red-orange and dark black palette, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred seventy pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, flame sweep, dash recoil, magma pulse, seamless loop. |
| lava_boss_3 | `res://assets/bosses/lava/lava_boss_3.png` and `.tres` | Lava boss warship or volcanic entity, hand-painted style, volcanic artillery beast, hexagonal body with giant forward magma cannon, obsidian plating, lava vents and eruptive fissures, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, cannon oriented toward the bottom of the image, three hundred ninety pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, charge glow, eruption blast, cannon recoil, idle smoke pulse, seamless loop. |
| lava_boss_4 | `res://assets/bosses/lava/lava_boss_4.png` and `.tres` | Lava boss warship or volcanic entity, hand-painted 2D game sprite, molten crusher titan, broad square silhouette, layered obsidian armor, furnace vents, lava rivers across the hull and heavy side bulges, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, lava surge, heavy recoil, flame breath pulse, seamless loop. |
| lava_boss_5 | `res://assets/bosses/lava/lava_boss_5.png` and `.tres` | Lava boss warship or volcanic entity, hand-painted style, infernal crown vessel, diamond silhouette with a radiant magma core, obsidian spines, flaming ring motifs and molten vents, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred twenty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, crown flare, flame ring pulse, attack wind up, seamless loop. |
| lava_boss_final | `res://assets/bosses/lava/lava_boss_final.png` and `.tres` | Final lava boss warship or volcanic entity, hand-painted 2D game sprite, colossal volcano heart leviathan, massive circular silhouette with erupting magma crown, obsidian armor petals, giant furnace core and radial flame vents, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred forty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, ten to fourteen frames, massive eruption, lava wave, core overcharge, ultimate idle burn, seamless loop. |

### Bosses Mine

| Boss | Path | Prompt image Ludo.ai | Prompt animation Ludo.ai |
|------|------|----------------------|--------------------------|
| mine_boss_1 | `res://assets/bosses/mine/mine_boss_1.png` and `.tres` | Mine and crystal themed boss, hand-painted style, ore sentinel, circular silhouette with embedded gemstones, rough rock plating and glowing crystal seams, brown violet and black tones, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred seventy pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, crystal shimmer, tremor pulse, idle glow, seamless loop. |
| mine_boss_2 | `res://assets/bosses/mine/mine_boss_2.png` and `.tres` | Mine and crystal themed boss, hand-painted 2D game sprite, drilling excavator warship, triangular silhouette with forward rotary drill, ore plating, crystal sockets and dust vents, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred eighty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, drill spin, crystal sparks, short recoil, seamless loop. |
| mine_boss_3 | `res://assets/bosses/mine/mine_boss_3.png` and `.tres` | Mine and crystal themed boss, hand-painted style, shard artillery platform, hexagonal body with giant crystal cannon, layered stone armor and jagged amethyst growths, brown-violet palette, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, cannon oriented toward the bottom of the image, three hundred ninety pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, crystal charge, shard burst, cannon recoil, idle pulse, seamless loop. |
| mine_boss_4 | `res://assets/bosses/mine/mine_boss_4.png` and `.tres` | Mine and crystal themed boss, hand-painted 2D game sprite, gem guardian crusher, broad square silhouette, thick ore armor, faceted crystal shoulders and a bright geode core, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred ten pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, heavy tremor, crystal pulse, debris shake, seamless loop. |
| mine_boss_5 | `res://assets/bosses/mine/mine_boss_5.png` and `.tres` | Mine and crystal themed boss, hand-painted style, geomancer queen vessel, diamond silhouette with elegant crystal wings, rune-carved ore plates and radiant violet core, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred thirty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, shard orbit, crystal glow pulse, attack wind up, seamless loop. |
| mine_boss_final | `res://assets/bosses/mine/mine_boss_final.png` and `.tres` | Final mine and crystal themed boss, hand-painted 2D game sprite, colossal crystal mountain engine, massive circular and angular hybrid silhouette, giant gemstone core, ore armor slabs, drilling limbs and radial crystal crowns, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred fifty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, ten to fourteen frames, giant drill spin, crystal storm, core overcharge, tremor idle, seamless loop. |

### Bosses Necro

| Boss | Path | Prompt image Ludo.ai | Prompt animation Ludo.ai |
|------|------|----------------------|--------------------------|
| necro_boss_1 | `res://assets/bosses/necro/necro_boss_1.png` and `.tres` | Necro boss warship or spectral horror, hand-painted style, bone warden, circular silhouette with skull motifs, ghost flames and cracked armor plates, violet and black palette, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred eighty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, spectral flicker, ghost pulse, idle float, seamless loop. |
| necro_boss_2 | `res://assets/bosses/necro/necro_boss_2.png` and `.tres` | Necro boss warship or spectral horror, hand-painted 2D game sprite, cursed reaper fighter, triangular silhouette with bony fins, soul vents and dark spectral plating, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, three hundred ninety pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, spirit trail, dash recoil, aura flicker, seamless loop. |
| necro_boss_3 | `res://assets/bosses/necro/necro_boss_3.png` and `.tres` | Necro boss warship or spectral horror, hand-painted style, soul artillery altar, hexagonal body with a giant forward soul cannon, bone ribs, ghost lanterns and cursed metal, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, cannon oriented toward the bottom of the image, four hundred pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, soul charge, spirit burst, altar glow, seamless loop. |
| necro_boss_4 | `res://assets/bosses/necro/necro_boss_4.png` and `.tres` | Necro boss warship or spectral horror, hand-painted 2D game sprite, grave titan vessel, broad square silhouette, coffin armor plates, skull reliefs, black smoke vents and a bright cursed core, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred twenty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, smoke pulse, heavy recoil, spectral glow, seamless loop. |
| necro_boss_5 | `res://assets/bosses/necro/necro_boss_5.png` and `.tres` | Necro boss warship or spectral horror, hand-painted style, ghost crown monarch, diamond silhouette with bone crown, layered spectral veils and necrotic sigils, violet-black palette, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred forty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, spectral apparition, sigil pulse, attack wind up, seamless loop. |
| necro_boss_final | `res://assets/bosses/necro/necro_boss_final.png` and `.tres` | Final necro boss warship or spectral horror, hand-painted 2D game sprite, colossal death shrine leviathan, huge circular silhouette with bone crown ring, ghost swirls, cursed armor petals and a blazing soul core, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, front side oriented toward the bottom of the image, four hundred sixty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, ten to fourteen frames, spirit wave, phase aura, soul overcharge, seamless loop. |

### Bosses Titan

| Boss | Path | Prompt image Ludo.ai | Prompt animation Ludo.ai |
|------|------|----------------------|--------------------------|
| titan_boss_1 | `res://assets/bosses/titan/titan_boss_1.png` and `.tres` | Titan boss warship, hand-painted style, divine sentinel, circular silhouette with golden armor petals, amber core and sacred rune engravings, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, nose pointed toward the bottom of the image, four hundred pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, eight to twelve frames, rune pulse, halo shimmer, imposing idle, seamless loop. |
| titan_boss_2 | `res://assets/bosses/titan/titan_boss_2.png` and `.tres` | Titan boss warship, hand-painted 2D game sprite, celestial spear cruiser, triangular silhouette with temple wings, white-gold armor and radiant core lines, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, nose pointed toward the bottom of the image, four hundred ten pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, eight to twelve frames, lightning pulse, forward dash recoil, holy glow, seamless loop. |
| titan_boss_3 | `res://assets/bosses/titan/titan_boss_3.png` and `.tres` | Titan boss warship, hand-painted style, temple cannon platform, hexagonal silhouette with giant forward divine cannon, sacred runes, marble-like armor and amber halos, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, cannon pointed toward the bottom of the image, four hundred twenty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, eight to twelve frames, holy charge, cannon blast recoil, rune lighting, seamless loop. |
| titan_boss_4 | `res://assets/bosses/titan/titan_boss_4.png` and `.tres` | Titan boss warship, hand-painted 2D game sprite, colossal guardian barge, broad square silhouette, layered divine armor, giant amber core, temple engravings and shield fins, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, nose pointed toward the bottom of the image, four hundred forty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, eight to twelve frames, shield pulse, heavy impact recoil, lightning flicker, seamless loop. |
| titan_boss_5 | `res://assets/bosses/titan/titan_boss_5.png` and `.tres` | Titan boss warship, hand-painted style, sky archivist throne, diamond silhouette with luminous rune rings, divine crown fins and white-gold architecture details, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, nose pointed toward the bottom of the image, four hundred fifty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, eight to twelve frames, rotating halos, mana pulse, attack wind up, seamless loop. |
| titan_boss_final | `res://assets/bosses/titan/titan_boss_final.png` and `.tres` | Final titan boss warship, hand-painted 2D game sprite, colossal divine machine emperor, massive circular silhouette with temple crown, sacred armor petals, huge amber reactor and radiant rune arrays, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, facing downward, nose pointed toward the bottom of the image, four hundred seventy pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, facing downward, ten to fourteen frames, colossal gesture, lightning storm pulse, divine overcharge, imposing idle, seamless loop. |

### Bosses Alien

| Boss | Path | Prompt image Ludo.ai | Prompt animation Ludo.ai |
|------|------|----------------------|--------------------------|
| alien_boss_1 | `res://assets/bosses/alien/alien_boss_1.png` and `.tres` | Organic alien boss, hand-painted 2D game sprite, hive drone overlord, circular chitinous silhouette with fleshy vents, green palette with purple accents, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, head or front side oriented toward the bottom of the image, four hundred twenty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, organic pulsation, twitching plates, idle loop. |
| alien_boss_2 | `res://assets/bosses/alien/alien_boss_2.png` and `.tres` | Organic alien boss, hand-painted style, parasite spear fighter, triangular biomass silhouette with sharp carapace fins, tendrils and glowing sacs, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, head or front side oriented toward the bottom of the image, four hundred thirty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, flesh pulse, dash recoil, bio glow, idle loop. |
| alien_boss_3 | `res://assets/bosses/alien/alien_boss_3.png` and `.tres` | Organic alien boss, hand-painted 2D game sprite, spore artillery beast, hexagonal organic silhouette with giant bio-cannon, chitin armor, spore sacs and vein patterns, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, forward weapon oriented toward the bottom of the image, four hundred forty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, spore inflation, bio shot recoil, pulsating idle, loop. |
| alien_boss_4 | `res://assets/bosses/alien/alien_boss_4.png` and `.tres` | Organic alien boss, hand-painted style, brood crusher tank, broad square silhouette, layered carapace, biomass bulges, tendon ridges and toxic vents, green and purple palette, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, head or front side oriented toward the bottom of the image, four hundred fifty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, breathing pulse, acid vent flicker, heavy recoil, idle loop. |
| alien_boss_5 | `res://assets/bosses/alien/alien_boss_5.png` and `.tres` | Organic alien boss, hand-painted 2D game sprite, hive queen oracle, diamond silhouette with crown-like carapace fins, tendril halo and glowing biomass core, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, head or front side oriented toward the bottom of the image, four hundred sixty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, eight to twelve frames, tendril wave, psychic pulse, organic shimmer, idle loop. |
| alien_boss_final | `res://assets/bosses/alien/alien_boss_final.png` and `.tres` | Final organic alien boss, hand-painted style, colossal hive leviathan, massive circular silhouette with layered chitin crown, giant biomass core, tendril wreath and spore chambers, green palette with purple highlights, strict top-down view, seen directly from above, orthographic, no perspective, not isometric, not three quarter view, head or front side oriented toward the bottom of the image, four hundred eighty pixels, transparent background. | Hand-painted sprite sheet, strict top-down view, ten to fourteen frames, massive organic pulsation, spore storm, bio overcharge, idle loop. |
